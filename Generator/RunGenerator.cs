...
[Generator]
public class RunGenerator : IIncrementalGenerator
{
    private static string Namespace = "RunGenerator";
    private static string ClassName = "GeneratedRuns";
    private static string AttributeName = "GenerateRunAttribute";
        ...
        IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput(ctx => ctx.AddSource(
            $"{AttributeName}.g.cs",
            SourceText.From(RunSourceUtil.GetAttributeSource(Namespace, AttributeName), Encoding.UTF8)));
    }
        ...
        SourceProductionContext context)
    {
        ...
        string result = RunSourceUtil.GetSource(methodToGenerates, Namespace, ClassName);
...
public static class RunSourceUtil
{
